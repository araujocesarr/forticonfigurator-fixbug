...
import Ports40F from "./Ports60F";
  ...
  const [portConfigs, setPortConfigs] = useContext(GlobalVarContext);
  console.log(portConfigs);

  const [selectedPort, setSelectedPort] = useContext(GlobalVarContext);
  const [submenuOpen, setSubmenuOpen] = useContext(GlobalVarContext);
  console.log(portConfigs);
  ...
  const handleConfigChange = (e, configKey) => {
    ...
    } else if (configKey === "https" || configKey === "ping") {
      updatedPortConfigs[index][configKey] = e.target.checked ? configKey : "";
    } else {
        ...
        {selectedPort !== null && (
          <div className="submenu">
            <form>
              ...
              {portConfigs.find((config) => config.portNumber === selectedPort)
                .enableDhcp === "enable" && (
                  ...
                  <ol>
                    ...
                    <li>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleConfigChange(e, "addressRangeFrom")
                        }
                      />
                    </li>
                    <li>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleConfigChange(e, "addressRangeTo")
                        }
                      />
                    </li>
                    <li>
