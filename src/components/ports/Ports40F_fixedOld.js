...
export default function Ports40F() {
  ...
  const { defaultGateway_1, setDefaultGateway_1 } =
    useContext(GlobalVarContext);
  const { addressRangeFrom_1, setAddressRangeFrom_1 } =
    useContext(GlobalVarContext);
  const { addressRangeTo_1, setAddressRangeTo_1 } =
    useContext(GlobalVarContext);
  ...
  const { addressRangeFrom_2, setAddressRangeFrom_2 } =
    useContext(GlobalVarContext);
  const { addressRangeTo_2, setAddressRangeTo_2 } =
    useContext(GlobalVarContext);
  ...
  const { addressRangeFrom_3, setAddressRangeFrom_3 } =
    useContext(GlobalVarContext);
  const { addressRangeTo_3, setAddressRangeTo_3 } =
    useContext(GlobalVarContext);
  ...
  const { addressRangeFrom_A, setAddressRangeFrom_A } =
    useContext(GlobalVarContext);
  const { addressRangeTo_A, setAddressRangeTo_A } =
    useContext(GlobalVarContext);
  ...
  const { addressRangeFrom_WAN, setAddressRangeFrom_WAN } =
    useContext(GlobalVarContext);
  const { addressRangeTo_WAN, setAddressRangeTo_WAN } =
    useContext(GlobalVarContext);
  ...
  const handleCheckboxChange = (event) => {
    ...
    switch (name) {
      ...
      case "int_3":
        ...
        break;
      case "enableDhcp_3":
        setEnableDhcp_3(checked);
        break;
      case "int_A":
        setInt_A(checked);
        break;
      case "enableDhcp_A":
        setEnableDhcp_A(checked);
        break;
      case "int_WAN":
        setInt_WAN(checked);
        break;
      case "enableDhcp_WAN":
        setEnableDhcp_WAN(checked);
        break;
      default:
        break;
    }
